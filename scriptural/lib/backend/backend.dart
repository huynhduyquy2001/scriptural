...
import 'schema/daily_book_record.dart';
...
export 'schema/daily_book_record.dart';
...
/// Functions to query DailyBookRecords (as a Stream and as a Future).
Future<int> queryDailyBookRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DailyBookRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DailyBookRecord>> queryDailyBookRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DailyBookRecord.collection,
      DailyBookRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DailyBookRecord>> queryDailyBookRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
