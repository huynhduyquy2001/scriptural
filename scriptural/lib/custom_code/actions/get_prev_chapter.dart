...
Future<ChaptersRecord> getPrevChapter(ChaptersRecord currentChapter) async {
  ...
  // Nếu currentChapter không phải là chương đầu tiên, trả về chương đứng trước nó
  if (currentIndex > 0) {
    return chaptersList[currentIndex - 1];
  } else {
    // Nếu currentChapter là chương đầu tiên, trả về chương ở vị trí cuối cùng
    return chaptersList.last;
  }
}
